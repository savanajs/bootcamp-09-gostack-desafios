...
import { selectCheckinByStudentRequest, saveCheckinByStudentRequest } from '../../store/modules/checkin/actions';
...
export default function CheckinList({ navigation }) {
  ...
  const checkins = useSelector(state => state.checkin.checkins.map(item => ({
    ...item,
  ...
  function makeCheckin() {
    dispatch(saveCheckinByStudentRequest({
      id: idStudent,
    }));
  }
